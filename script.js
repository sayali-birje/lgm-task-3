...
submit.addEventListener('click',()=>{
    ...
    // var generatedurl=`https://drive.google.com/drive/folders/1DLu9JdTeBDCW_nt4hPSsEGJknKs0NQWa?usp=sharing=${imageurl}`;
   ...
   //storing the data in objects getting from form
    ...
    newlist.innerHTML=`
      ...
      <a href="mailto:sayalibirje87@gmail.com">${data.email}</a><br>
